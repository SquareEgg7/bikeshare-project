...
1. Determine better way to show travel times:
    a. If you have filtered for "All" months and a single day of the week:
        i. It is unclear to display the month first.  If the only filter is day of week, then the logic is more clear if day of week is shown first.  If month is the only filter, or month and day or week are both filters, it is fine to show month first.  
        ii. Filtering for January and then determining that Friday is the most common start date does not mean that if you filter by Friday, January will be the most common start month.  
        iii. Is the most common month meaningless?  As an example, if you filtered for Sunday and then the analysis showed you that the most common month was July, you would know that people liked using the system on Sundays in July more than Sundays in any other month.  And this coud be different than if you filtered for July.  If you filtered for July, the analysis might show you that Friday was the most common day to use the system in July.
2. NaNs in df - adjusted user stats function to reflect NaNs in user type, gender, birth year
